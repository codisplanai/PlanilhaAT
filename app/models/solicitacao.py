...
from sqlalchemy import CheckConstraint, Column, Integer, String, Date, DateTime, ForeignKey, Text, JSON, Uuid
...
class Solicitacao(Base):
    ...
    usuario_id = Column(Uuid(as_uuid=False), ForeignKey("profiles.id", ondelete="SET NULL"), nullable=True, index=True)
